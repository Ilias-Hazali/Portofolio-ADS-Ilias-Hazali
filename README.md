...
Voor de `tags` dataset heb ik bijna het zelfde gedaan. Eerst heb ik de dataset geinspecteerd. Vervolgens heb ik de kolom `Unnamed: 0` verwijdert. Daarna gegroepeerd op recipeen en als laatste de datasets 'tags' en 'ingredients' samengevoegd en dat resulteerde in het volgende dataframe: ![image](https://user-images.githubusercontent.com/121435298/209864281-8c3bf52b-0378-48f8-8ccb-a3eeb58ad8b4.png)
